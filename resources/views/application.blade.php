...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            {{ $user->applicant ? 'Update' : 'Create' }}
        @endslot
        @slot('title')
            {{ $user->applicant ? $user->applicant->firstname.' '.$user->applicant->lastname : 'New Application' }}
        @endslot
    @endcomponent
                                                ...
                                                <div class="row gy-3">
                                                    ...
                                                    <div class="col-md-12 d-none" id="jobRetrenchedSpecifyColumn">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="jobRetrenchedSpecify" name="job_retrenched_specify" placeholder="Please specify the reaon" value="{{ $user->applicant ? $user->job_retrenched_specify->job_leave_specify : '' }}" />
                                                            <div class="invalid-feedback">
                                                                Please enter a reason
                                                            </div>
                                                        </div>
