                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Shoprite - Job Opportunities. Crafted with <i class="mdi mdi-heart text-danger"></i> by OTB Group</p>
                            </div>
                        </div>
                    </div>
                </div>
