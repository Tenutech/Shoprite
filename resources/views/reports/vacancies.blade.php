                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="store" name="store_id[]" multiple>
                                        ...
                                        @foreach ($stores as $store)
                                            <option value="{{ $store->id }}" brand-id="{{ $store->brand_id }}" division-id="{{ $store->division_id }}" region-id="{{ $store->region_id }}">{{ $store->code }} - {{ optional($store->brand)->name }} ({{ $store->name }})</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
