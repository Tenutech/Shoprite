                                                ...
                                                <div class="row gy-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="openPositions" name="open_positions" placeholder="Enter number of positions available" value="{{ $vacancy ? $vacancy->open_positions : '0' }}" min="0" required />
