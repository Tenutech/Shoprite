...
<div class="row">
    <div class="col">
        ...
        <div class="h-100">
            ...
            <div class="row g-3">
                <!-- Time to Shortlist -->
                <div class="col-xl-4 col-md-4" id="divisionAverageTimeToShortlistColumn">
                ...
                <!-- Time to Hire -->
                <div class="col-xl-4 col-md-4" id="divisionAverageTimeToHireColumn">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
...
<!-- dashboard init -->
<script src="{{URL::asset('build/js/pages/dtdp.init.js')}}?v={{ filemtime(public_path('build/js/pages/manager.init.js')) }}"></script>
