                        ...
                        <div class="py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0"><span class="counter-value" data-target="{{ $divisionWideAveragetimeToShortlist }}">{{ $divisionWideAveragetimeToShortlist }}</span>
                                    </h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0"><span class="counter-value"
                                            data-target="{{ $divisionWideTimeToHire }}">{{ $divisionWideTimeToHire }}</span></h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
        ...
        <div class="card crm-widget">
            <div class="card-body p-0">
                <div class="row row-cols-lg-3 row-cols-md-3 row-cols-1 g-0">
                    ...
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Average Distance for Succesfull Placements</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                    ...
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            <h5 class="text-muted text-uppercase fs-13">Total Average Distance</h5>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <i class="ri-exchange-dollar-line display-6 text-muted"></i>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0"><span class="counter-value"
                                            data-target="{{ $averageTalentPoolDistance }}">{{ $averageTalentPoolDistance }}</span>km</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
