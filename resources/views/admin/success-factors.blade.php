                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($successFactors)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive table-card mb-3">
                            <table class="table align-middle table-nowrap mb-0" id="qualificationTable">
                                ...
                                <tbody class="list form-check-all" style="height:200px;">
                                    @if($successFactors && count($successFactors) > 0)
                                        @foreach ($successFactors as $successFactor)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($successFactor->id) }}</td>
                                                <td class="position">{{ optional($successFactor->position)->name }}</td>
                                                <td class="description" style="white-space: pre-wrap;">{{ $successFactor->description }}</td>
                                                <td class="icon"><i class="{{ $successFactor->icon }} text-{{ $successFactor->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $successFactor->color }}">{{ $successFactor->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/success-factors.init.js') }}"></script>
