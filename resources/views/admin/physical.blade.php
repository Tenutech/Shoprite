                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($physicals)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive table-card mb-3">
                            <table class="table align-middle table-nowrap mb-0" id="qualificationTable">
                                ...
                                <tbody class="list form-check-all" style="height:200px;">
                                    @if($physicals && count($physicals) > 0)
                                        @foreach ($physicals as $physical)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($physical->id) }}</td>
                                                <td class="position">{{ optional($physical->position)->name }}</td>
                                                <td class="description" style="white-space: pre-wrap;">{{ $physical->description }}</td>
                                                <td class="icon"><i class="{{ $physical->icon }} text-{{ $physical->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $physical->color }}">{{ $physical->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/physical.init.js') }}"></script>
