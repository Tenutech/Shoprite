                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($hours)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($hours && count($hours) > 0)
                                        @foreach ($hours as $hour)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($hour->id) }}</td>
                                                <td class="position">{{ optional($hour->position)->name }}</td>
                                                <td class="description" style="white-space: pre-wrap;">{{ $hour->description }}</td>
                                                <td class="icon"><i class="{{ $hour->icon }} text-{{ $hour->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $hour->color }}">{{ $hour->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/hours.init.js') }}"></script>
