...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Divisional Talent Development Partner
        @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <div class="row g-3 mb-0 align-items-center">
                                <div class="col-sm-auto">
                                    <div class="hstack gap-1">
                                        <button type="button" id="exportDtdpsTableReport" class="btn btn-success btn-label">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="search-box">
                                <input type="text" id="custom-dtdps-search" class="form-control search" placeholder="Search for user...">
                                ...
                                <form id="formUser" action="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add DTDP</button>
                                            <button type="button" class="btn btn-success" id="edit-btn">Update DTDP</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/dtdps.init.js') }}"></script>
