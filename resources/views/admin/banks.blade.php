                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($banks)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($banks && count($banks) > 0)
                                        @foreach ($banks as $bank)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($bank->id) }}</td>
                                                <td class="name">{{ $bank->name }}</td>
                                                <td class="icon"><i class="{{ $bank->icon }} text-{{ $bank->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $bank->color }}">{{ $bank->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/banks.init.js') }}"></script>
