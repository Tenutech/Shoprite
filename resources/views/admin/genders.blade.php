                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($genders)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($genders && count($genders) > 0)
                                        @foreach ($genders as $gender)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($gender->id) }}</td>
                                                <td class="name">{{ $gender->name }}</td>
                                                <td class="icon"><i class="{{ $gender->icon }} text-{{ $gender->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $gender->color }}">{{ $gender->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/genders.init.js') }}"></script>
