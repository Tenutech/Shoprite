                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($languages)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($languages && count($languages) > 0)
                                        @foreach ($languages as $language)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($language->id) }}</td>
                                                <td class="name">{{ $language->name }}</td>
                                                <td class="icon"><i class="{{ $language->icon }} text-{{ $language->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $language->color }}">{{ $language->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/languages.init.js') }}"></script>
