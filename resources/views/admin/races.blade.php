                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($races)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($races && count($races) > 0)
                                        @foreach ($races as $race)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($race->id) }}</td>
                                                <td class="name">{{ $race->name }}</td>
                                                <td class="icon"><i class="{{ $race->icon }} text-{{ $race->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $race->color }}">{{ $race->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/races.init.js') }}"></script>
