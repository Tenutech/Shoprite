                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($salaries)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($salaries && count($salaries) > 0)
                                        @foreach ($salaries as $salary)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($salary->id) }}</td>
                                                <td class="position">{{ optional($salary->position)->name }}</td>
                                                <td class="description" style="white-space: pre-wrap;">{{ $salary->description }}</td>
                                                <td class="icon"><i class="{{ $salary->icon }} text-{{ $salary->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $salary->color }}">{{ $salary->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/salaries.init.js') }}"></script>
