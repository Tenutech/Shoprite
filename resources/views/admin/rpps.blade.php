                            ...
                            <div class="row g-3 mb-0 align-items-center">
                                <div class="col-sm-auto">
                                    <div class="hstack gap-1">
                                        <button type="button" id="exportTableReport" class="btn btn-success btn-label">
                                ...
                                <form id="formUser" action="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add RPP</button>
                                            <button type="button" class="btn btn-success" id="edit-btn">Update RPP</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/rpps.init.js') }}"></script>
