                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($roles)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($roles && count($roles) > 0)
                                        @foreach ($roles as $role)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($role->id) }}</td>
                                                <td class="name">{{ $role->name }}</td>
                                                <td class="icon"><i class="{{ $role->icon }} text-{{ $role->color }} fs-18"></i></td>
                                                <td class="color"><span class="text-{{ $role->color }}">{{ $role->color }}</span></td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/roles.init.js') }}"></script>
