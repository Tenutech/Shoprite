                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="{{count($towns)}}">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @if($towns && count($towns) > 0)
                                        @foreach ($towns as $town)
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none">{{ Crypt::encryptstring($town->id) }}</td>
                                                <td class="name">{{ $town->name }}</td>
                                                <td class="code">{{ $town->code }}</td>
                                                <td class="province">{{ optional($town->province)->name }}</td>
                                                <td class="district">{{ $town->district }}</td>
                                                <td class="seat">{{ $town->seat }}</td>
                                                <td class="class">{{ $town->class }}</td>
                                                <td>
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/towns.init.js') }}"></script>
