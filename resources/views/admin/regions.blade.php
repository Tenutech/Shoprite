                        ...
                        <div class="row g-3 mb-0 align-items-center">
                            <div class="col-sm-auto">
                                <div class="hstack gap-1">
                                    <button type="button" id="exportRegionsTableReport" class="btn btn-success btn-label">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="search-box">
                            <input type="text" id="custom-regions-search" class="form-control search" placeholder="Search for region...">
