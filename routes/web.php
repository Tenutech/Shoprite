...
Route::middleware(['auth', 'verified', 'user.activity'])->group(function () {
    ...
    Route::post('/help', [App\Http\Controllers\QueryController::class, 'index'])->name('help.index');

    Route::post('/queriers/store', [App\Http\Controllers\QueryController::class, 'store'])->name('query.store');
});
