    ...
    */
    ...
    private function fetchData(int $divisionId = null, Carbon $startDate, Carbon $endDate)
    {
        ...
        if ($divisionId !== null) {
            ...
            $divisionApplicantsAppointed = $this->applicantProximityService->fetchPlacedApplicants('division', $divisionId, $startDate, $endDate);
        ...
        // $divisionWideAverageTimeToShortlist = $this->vacancyDataService->getDivisionWideAverageTimeToShortlist($divisionId, $startDate, $endDate);
        // $divisionWideTimeToHire = $this->vacancyDataService->getDivisionWideAverageTimeToHire($divisionId, $startDate, $endDate);
