    ...
    */
    ...
    public function export(Request $request)
    {
        try {
            ...
            // Dispatch the job to generate the report and email it to the user
            ...
            return response()->json([
                'success' => true,
                'message' => 'The report is being processed and will be emailed to you shortly!'
            ], 200);
        } catch (\Exception $e) {
