...
class ApplicantsReportDataService
{
     ...
     */
    public function getTotalApplicantsAppointedByMonth(string $type, ?int $id, $startDate, $endDate): array
    {
     ...
     */
    public function getTotalApplicantsByMonthFiltered(string $type, Carbon $startDate, Carbon $endDate, float $maxDistanceFromStore, array $filters): array
    {
        $maxDistanceFromStore = $maxDistanceFromStore ?? 50;
