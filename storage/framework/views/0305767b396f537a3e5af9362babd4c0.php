<?php $__env->startSection('title'); ?> Orient  - Where Potential Meets Opportunity <?php $__env->stopSection(); ?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            ?>
                            <a href="<?php echo e(url($url.'home')); ?>" class="btn btn-soft-success">
                                <i class="ri-home-line align-bottom me-1"></i> 
                                Home
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-soft-primary">
                                <i class="ri-user-3-line align-bottom me-1"></i> 
                                Login
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-soft-danger">
                                <i class="ri-user-3-line align-bottom me-1"></i> 
                                Register
                            </a>
                        <?php endif; ?>
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            ...
                            <div class="card p-3 rounded shadow-lg application-box">
                                ...
                                <div class="avatar-group">
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                        <div class="avatar-xs">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-17.jpg')); ?>" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ellen Smith">
                                        <div class="avatar-xs">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-16.jpg')); ?>" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                        <div class="avatar-xs">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-12.jpg')); ?>" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                            ...
                            <img src="<?php echo e(URL::asset('build/images/job-profile3.png')); ?>" alt="" class="user-img">
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="<?php echo e(route('register')); ?>" class="btn bg-gradient btn-danger">Create Free Account</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-17.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-15.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                            <h5 class="fs-17 mt-3 mb-2">
                                                Lebo Moletsane
                                            </h5>
                                            <p class="text-muted fs-13 mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-16.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                            <h5 class="fs-17 mt-3 mb-2">
                                                Siyabonga Ntuli
                                            </h5>
                                            <p class="text-muted fs-13 mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-12.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                                            <h5 class="fs-17 mt-3 mb-2">
                                                Zweli Dlamini
                                            </h5>
                                            <p class="text-muted fs-13 mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-13.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                                            <h5 class="fs-17 mt-3 mb-2">
                                                Nomsa Radebe
                                            </h5>
                                            <p class="text-muted fs-13 mb-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-11.jpg')); ?>" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                                            <h5 class="fs-17 mt-3 mb-2">
                                                Themba Nxumalo
                                            </h5>
                                            <p class="text-muted fs-13 mb-3">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" placeholder="Enter your email" aria-label="Example text with button addon" aria-describedby="button-addon1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-5">
                            <div class="subscribe-modals-cover h-100">
                                <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="h-100 w-100 object-fit-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                            </div>
                        </div>
                    </div>
                </div><!-- /.modal-content -->
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end mt-3 mt-sm-0">
                            <ul class="list-inline mb-0 footer-list gap-4 fs-15">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?php echo e(route('security')); ?>">Security</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <?php $__env->startSection('script'); ?>
        ...
        <script src="<?php echo e(URL::asset('build/js/pages/subscribe.init.js')); ?>"></script>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shadley/Development/Sourcecode/tenubah/Orient/resources/views/welcome.blade.php ENDPATH**/ ?>