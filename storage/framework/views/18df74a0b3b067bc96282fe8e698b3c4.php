            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary fw-semibold">
                            <span class="counter-value" data-target="<?php echo e($amendVacancies); ?>">
                                0
                            </span>
                        </h2>
                        <p class="mb-0 text-muted">
                            <span class="badge bg-light text-<?php echo e($movementAmend == 0 ? 'warning' : ($movementAmend < 0 ? 'danger' : 'success')); ?> mb-0">
                                <i class="ri-arrow-<?php echo e($movementAmend == 0 ? 'right' : ($movementAmend < 0 ? 'down' : 'up')); ?>-line align-middle"></i> 
                                <?php echo e($movementAmend); ?> %
                            </span> vs. previous month
                        </p>
                    </div>
                    <div>
                            ...
                            <?php if($vacancies && count($vacancies) > 0): ?>
                                <?php $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="id d-none"><?php echo e(Crypt::encryptString($vacancy->id)); ?></td>
                                        <td class="name">
                                            <a href="<?php echo e(route('job-overview.index', ['id' => Crypt::encryptString($vacancy->id)])); ?>">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <i class="<?php echo e($vacancy->position->icon); ?> text-<?php echo e($vacancy->position->color); ?> avatar-xs rounded-circle fs-3"></i>
                                                    </div>
                                        ...
                                        <td class="user">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 tasks_name">
                                                    <?php echo e($vacancy->user->firstname); ?> <?php echo e($vacancy->user->lastname); ?>
                                        ...
                                        <td class="status">
                                            <span class="badge bg-<?php echo e($vacancy->status->color); ?>-subtle text-<?php echo e($vacancy->status->color); ?> text-uppercase">
...
<script src="<?php echo e(URL::asset('build/js/pages/approval.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/approvals.blade.php ENDPATH**/ ?>