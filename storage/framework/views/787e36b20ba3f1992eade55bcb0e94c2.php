                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($weightings)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive table-card mb-3">
                            <table class="table align-middle table-nowrap mb-0" id="weightingTable">
                                ...
                                <tbody class="list form-check-all" style="height:200px;">
                                    <?php if($weightings && count($weightings) > 0): ?>
                                        <?php $__currentLoopData = $weightings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weighting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($weighting->id)); ?></td>
                                                <td class="score_type"><?php echo e($weighting->score_type); ?></td>
                                                <td class="weight"><?php echo e($weighting->weight); ?></td>
                                                <td class="max_value"><?php echo e($weighting->max_value); ?></td>
                                                <td class="condition_field"><?php echo e($weighting->condition_field); ?></td>
                                                <td class="condition_value"><?php echo e($weighting->condition_value); ?></td>
                                                <td class="fallback_value"><?php echo e($weighting->fallback_value); ?></td>
                                                <td>
                        ...
                        <div class="d-flex justify-content-between mt-3 align-items-center">
                            <div class="col-md-auto">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="badge bg-primary" id="totalWeight"><?php echo e($totalWeight); ?></span>
                                </div>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/weighting.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/weighting.blade.php ENDPATH**/ ?>