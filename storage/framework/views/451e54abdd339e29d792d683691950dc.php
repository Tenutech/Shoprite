                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">
                                        <span class="badge bg-light text-secondary mb-0">
                                            <?php echo e($previousYearData->year); ?>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-bold">
                                        <span class="counter-value" data-target="<?php echo e($previousYearData->total_applicants > 0 ? round($previousYearData->total_appointed / $previousYearData->total_applicants * 100) : 0); ?>">
                                            0
                                        </span>%
                                    </h2>
                                    <p class="mb-0 text-muted">
