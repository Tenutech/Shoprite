                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($qualifications)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php if($qualifications && count($qualifications) > 0): ?>
                                        <?php $__currentLoopData = $qualifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($qualification->id)); ?></td>
                                                <td class="position"><?php echo e(optional($qualification->position)->name); ?></td>
                                                <td class="description"><?php echo e($qualification->description); ?></td>
                                                <td class="icon"><i class="<?php echo e($qualification->icon); ?> text-<?php echo e($qualification->color); ?> fs-18"></i></td>
                                                <td class="color"><span class="text-<?php echo e($qualification->color); ?>"><?php echo e($qualification->color); ?></span></td>
                                                <td>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/qualifications.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/qualifications.blade.php ENDPATH**/ ?>