                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($physicals)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive table-card mb-3">
                            <table class="table align-middle table-nowrap mb-0" id="qualificationTable">
                                ...
                                <tbody class="list form-check-all" style="height:200px;">
                                    <?php if($physicals && count($physicals) > 0): ?>
                                        <?php $__currentLoopData = $physicals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $physical): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($physical->id)); ?></td>
                                                <td class="position"><?php echo e(optional($physical->position)->name); ?></td>
                                                <td class="description"><?php echo e($physical->description); ?></td>
                                                <td class="icon"><i class="<?php echo e($physical->icon); ?> text-<?php echo e($physical->color); ?> fs-18"></i></td>
                                                <td class="color"><span class="text-<?php echo e($physical->color); ?>"><?php echo e($physical->color); ?></span></td>
                                                <td>
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">
                                        We've searched all the physical requirements. We did not find any physical requirements for you search.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        <h4 class="fs-semibold">
                                            You are about to delete this physical requirement ?
                                        </h4>
                                        <p class="text-muted fs-14 mb-4 pt-1">
                                            Deleting this physical requirement will remove all of the information from the database.
                                        </p>
                                        <div class="hstack gap-2 justify-content-center remove">
                                            ...
                                            <button class="btn btn-primary" id="delete-physical">
                                                Yes, Delete!!
                                            </button>
                                        </div>
                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/physical.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/physical.blade.php ENDPATH**/ ?>