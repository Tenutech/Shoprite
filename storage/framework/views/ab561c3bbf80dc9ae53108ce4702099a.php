                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarJobs">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('physical.index')); ?>">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('responsibilities.index')); ?>">
                                        Responsibilities
                                    </a>
                                </li>
                                <li class="nav-item">
...
<?php /**PATH /Users/shadley/Development/Sourcecode/tenubah/Orient/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>