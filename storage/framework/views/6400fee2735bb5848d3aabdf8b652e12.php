                ...
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#brandModal">
        ...
        <div class="col-xxl-12">
            <div class="card" id="brandList">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="search-box">
                                <input type="text" class="form-control search" placeholder="Search for brand...">
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($brands)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                            ...
                            <table class="table align-middle table-nowrap mb-0" id="brandTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="icon" scope="col">Image</th>
                                    ...
                                    <?php if($brands && count($brands) > 0): ?>
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($brand->id)); ?></td>
                                                <td class="icon"><img src="<?php echo e(URL::asset($brand->icon)); ?>" alt="" class="avatar-lg object-cover"></td>
                                                <td class="name"><?php echo e($brand->name); ?></td>                                                
                                                <td class="color"><span class="text-<?php echo e($brand->color); ?>"><?php echo e($brand->color); ?></span></td>
                                                <td>
                                                        ...
                                                        <li class="list-inline-item">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li>
                                                                        <a class="dropdown-item edit-item-btn" href="#brandModal" data-bs-toggle="modal">
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">
                                        We've searched all the brands. We did not find any brands for you search.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Modal Brand -->
                    <div class="modal fade zoomIn" id="brandModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-xg p-1">
                                                        <div class="avatar-title bg-light rounded-circle">
                                                            <img src="<?php echo e(URL::asset('build/images/brands/shoprite-logo.svg')); ?>" alt="" id="brand-img" class="avatar-lg rounded-circle object-cover">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                                    
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <p class="text-muted fs-14 mb-4 pt-1">
                                            Deleting this brand will remove all of the information from the database.
                                        </p>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/brands.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/brands.blade.php ENDPATH**/ ?>