                ...
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#roleModal">
        ...
        <div class="col-xxl-12">
            <div class="card" id="roleList">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="search-box">
                                <input type="text" class="form-control search" placeholder="Search for role...">
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($roles)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                                    ...
                                    <?php if($roles && count($roles) > 0): ?>
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($role->id)); ?></td>
                                                <td class="name"><?php echo e($role->name); ?></td>
                                                <td class="icon"><i class="<?php echo e($role->icon); ?> text-<?php echo e($role->color); ?> fs-18"></i></td>
                                                <td class="color"><span class="text-<?php echo e($role->color); ?>"><?php echo e($role->color); ?></span></td>
                                                <td>
                                                        ...
                                                        <li class="list-inline-item">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li>
                                                                        <a class="dropdown-item edit-item-btn" href="#roleModal" data-bs-toggle="modal">
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">
                                        We've searched all the roles. We did not find any roles for you search.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Modal Role -->
                    <div class="modal fade zoomIn" id="roleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content border-0">
                                ...
                                <form id="fromRole" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <p class="text-muted fs-14 mb-4 pt-1">
                                            Deleting this role will remove all of the information from the database.
                                        </p>
                                        <div class="hstack gap-2 justify-content-center remove">
                                            ...
                                            <button class="btn btn-primary" id="delete-role">
                                                Yes, Delete!!
                                            </button>
                                        </div>
                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/roles.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/roles.blade.php ENDPATH**/ ?>