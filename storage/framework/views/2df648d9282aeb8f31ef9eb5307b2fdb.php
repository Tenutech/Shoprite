                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="user-thumb text-center">
                                <img src="<?php echo e(URL::asset('images/avatar-1.jpg')); ?>" class="rounded-circle img-thumbnail avatar-lg" alt="thumbnail">
                                <h5 class="font-size-15 mt-3">Hanno Burger</h5>
                            </div>
                            <div class="p-2 mt-4">
                                <form>
                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/lockscreen.blade.php ENDPATH**/ ?>