...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?>
            <?php echo e($user->applicant ? 'Update' : 'Create'); ?>

        <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?>
            <?php echo e($user->applicant ? $user->applicant->firstname.' '.$user->applicant->lastname : 'New Application'); ?>
                                                ...
                                                <div class="row gy-3">
                                                    ...
                                                    <div class="col-md-12 d-none" id="jobRetrenchedSpecifyColumn">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="jobRetrenchedSpecify" name="job_retrenched_specify" placeholder="Please specify the reaon" value="<?php echo e($user->applicant ? $user->applicant->job_leave_specify : ''); ?>" />
                                                            <div class="invalid-feedback">
                                                                Please enter a reason
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/application.blade.php ENDPATH**/ ?>