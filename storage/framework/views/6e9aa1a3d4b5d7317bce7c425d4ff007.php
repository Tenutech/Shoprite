    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body bg-light-subtle">
                <form action="<?php echo e(route('admin.home')); ?>" method="post" id="filterForm">
                    <?php echo csrf_field(); ?> 
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body bg-light-subtle">
            <h4 class="fs-16 mb-1">
                Showing data for <?php echo e($startOfYear); ?> to <?php echo e($endOfYear); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-primary fw-bold">
                                        <span><?php echo e($formattedInterval); ?></span>
                                    </h2>
                                    <p class="mb-0 text-muted">
                                        <span class="badge bg-light text-primary mb-0">
                                            <?php echo e($currentYearData->year); ?>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-primary fw-bold">
                                        <span class="counter-value" data-target="<?php echo e($currentYearData->total_applicants > 0 ? round($currentYearData->total_appointed / $currentYearData->total_applicants * 100) : 0); ?>">
                                            0
                                        </span>%
                                    </h2>
                                    <p class="mb-0 text-muted">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shadley/Development/Sourcecode/tenubah/Orient/resources/views/admin/home.blade.php ENDPATH**/ ?>