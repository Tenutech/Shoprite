                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($guides)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php if($guides && count($guides) > 0): ?>
                                        <?php $__currentLoopData = $guides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($guide->id)); ?></td>
                                                <td class="question" style="white-space: pre-wrap;"><?php echo $guide->question; ?></td>
                                                <td class="icon"><i class="<?php echo e($guide->icon); ?> text-<?php echo e($guide->color); ?> fs-18"></i></td>
                                                <td class="color"><span class="text-<?php echo e($guide->color); ?>"><?php echo e($guide->color); ?></span></td>
                                                <td>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/interview-guides.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/interview-guides.blade.php ENDPATH**/ ?>