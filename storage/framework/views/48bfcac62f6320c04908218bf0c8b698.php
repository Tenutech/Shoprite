                ...
                <div class="table-responsive table-card mb-4">
                    <table class="table align-middle table-nowrap mb-0" id="applicantsTable">
                        ...
                        <tbody class="list form-check-all">
                            <?php if($applicants && count($applicants) > 0): ?>
                                <?php $__currentLoopData = $applicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th scope="row">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="chk_child" value="<?php echo e(Crypt::encryptString($applicant->id)); ?>">
                                            </div>
                                        </th>
                                        <td class="id d-none"><?php echo e(Crypt::encryptString($applicant->id)); ?></td>
                                        <td class="name">
                                            <a href="<?php echo e(route('applicant-profile.index', ['id' => Crypt::encryptString($applicant->id)])); ?>">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e($applicant->avatar ?? 'images/avatar.jpg'); ?>" alt="" class="avatar-xs rounded-circle">
                                                    </div>
                                        ...
                                        <td class="email"><?php echo e($applicant->email ?? 'N/A'); ?></td>
                                        <td class="position">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 tasks_name">
                                                    <?php echo e($applicant->position ? ($applicant->position->name == 'Other' ? $applicant->position_specify : $applicant->position->name) : 'N/A'); ?>
                                        ...
                                        <td class="gender d-none"><?php echo e($applicant->gender->name ?? 'N/A'); ?></td>
                                        <td class="race d-none"><?php echo e($applicant->race->name ?? 'N/A'); ?></td>
                                        <td class="location"><?php echo e($applicant->town->name  ?? 'N/A'); ?></td>
                                        <td class="education"><?php echo e($applicant->education->name  ?? 'N/A'); ?></td>
                                        <td class="reason"><?php echo e($applicant->reason ? ($applicant->reason->name == 'Other' ? $applicant->application_reason_specify : $applicant->reason->name) : 'N/A'); ?></td>                                        
                                        <td class="date"><?php echo e(date('d M Y', strtotime($applicant->created_at)) ?? 'N/A'); ?></td>
                                        <td class="status">
...
<script src="<?php echo e(URL::asset('build/js/pages/applicant-approval.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/applicant-approvals.blade.php ENDPATH**/ ?>