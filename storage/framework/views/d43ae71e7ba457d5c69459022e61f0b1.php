                ...
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#salaryModal">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="search-box">
                                <input type="text" class="form-control search" placeholder="Search for salary...">
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-control mb-0" id="per-page-select" data-choices data-choices-search-false>
                                    ...
                                    <option value="<?php echo e(count($salaries)); ?>">All</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div>
                        <div class="table-responsive table-card mb-3">
                            <table class="table align-middle table-nowrap mb-0" id="salaryTable">
                                ...
                                <tbody class="list form-check-all" style="height:200px;">
                                    <?php if($salaries && count($salaries) > 0): ?>
                                        <?php $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="vertical-align:top;">
                                                ...
                                                <td class="id d-none"><?php echo e(Crypt::encryptstring($salary->id)); ?></td>
                                                <td class="position"><?php echo e(optional($salary->position)->name); ?></td>
                                                <td class="description"><?php echo e($salary->description); ?></td>
                                                <td class="icon"><i class="<?php echo e($salary->icon); ?> text-<?php echo e($salary->color); ?> fs-18"></i></td>
                                                <td class="color"><span class="text-<?php echo e($salary->color); ?>"><?php echo e($salary->color); ?></span></td>
                                                <td>
                                                        ...
                                                        <li class="list-inline-item">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li>
                                                                        <a class="dropdown-item edit-item-btn" href="#salaryModal" data-bs-toggle="modal">
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">
                                        We've searched all the salaries. We did not find any salaries for you search.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Modal Salary -->
                    <div class="modal fade zoomIn" id="salaryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content border-0">
                                ...
                                <form id="formSalary" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-footer">                                        
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add Salary</button>
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        <h4 class="fs-semibold">
                                            You are about to delete this salary ?
                                        </h4>
                                        <p class="text-muted fs-14 mb-4 pt-1">
                                            Deleting this salary will remove all of the information from the database.
                                        </p>
                                        <div class="hstack gap-2 justify-content-center remove">
                                            ...
                                            <button class="btn btn-primary" id="delete-salary">
                                                Yes, Delete!!
                                            </button>
                                        </div>
                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/salaries.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Recruitment\resources\views/admin/salaries.blade.php ENDPATH**/ ?>