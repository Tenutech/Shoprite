...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('applicants', function (Blueprint $table) {
            if (!Schema::hasIndex('applicants', 'idx_applicants_gender_id')) {
                $table->index('gender_id', 'idx_applicants_gender_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_race_id')) {
                $table->index('race_id', 'idx_applicants_race_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_education_id')) {
                $table->index('education_id', 'idx_applicants_education_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_duration_id')) {
                $table->index('duration_id', 'idx_applicants_duration_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_employment')) {
                $table->index('employment', 'idx_applicants_employment');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_age')) {
                $table->index('age', 'idx_applicants_age');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_literacy_score')) {
                $table->index('literacy_score', 'idx_applicants_literacy_score');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_numeracy_score')) {
                $table->index('numeracy_score', 'idx_applicants_numeracy_score');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_situational_score')) {
                $table->index('situational_score', 'idx_applicants_situational_score');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_score')) {
                $table->index('score', 'idx_applicants_score');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_created_at')) {
                $table->index('created_at', 'idx_applicants_created_at');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_state_id')) {
                $table->index('state_id', 'idx_applicants_state_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_shortlist_id')) {
                $table->index('shortlist_id', 'idx_applicants_shortlist_id');
            }
            if (!Schema::hasIndex('applicants', 'idx_applicants_appointed_id')) {
        ...
        Schema::table('shortlists', function (Blueprint $table) {
            if (!Schema::hasIndex('shortlists', 'idx_shortlists_vacancy_id')) {
        ...
        Schema::table('interviews', function (Blueprint $table) {
            if (!Schema::hasIndex('interviews', 'idx_interviews_vacancy_id')) {
        ...
        Schema::table('vacancies', function (Blueprint $table) {
            if (!Schema::hasIndex('vacancies', 'idx_vacancies_store_id')) {
        ...
        Schema::table('stores', function (Blueprint $table) {
            if (!Schema::hasIndex('stores', 'idx_stores_division_id')) {
                $table->index('division_id', 'idx_stores_division_id');
            }
            if (!Schema::hasIndex('stores', 'idx_stores_region_id')) {
        ...
        Schema::table('vacancy_fills', function (Blueprint $table) {
            if (!Schema::hasIndex('vacancy_fills', 'idx_vacancy_fills_created_at')) {
